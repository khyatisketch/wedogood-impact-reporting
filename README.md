...
2. Backend creates a job entry with status PENDING
3. CSV is parsed in memory
4. Rows are processed one-by-one in the background
5. Job progress (processed_rows, failed_rows) is updated after each row
6. Job status is marked COMPLETED or FAILED
